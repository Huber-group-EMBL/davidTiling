...
%--------------------------------------------------
The package is currently under rapid development. It is provided
\textit{as is}, with no pretense of it being finished. Some desirable
functionality is still missing, other is poorly documented. There are
some very nice function in there, though.

If you want an easy-to-use package, please come back at a later time.
If you want to use this package now, please expect to spend some time
figuring out things for yourself or buggering me for explanation
